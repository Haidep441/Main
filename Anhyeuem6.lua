...
local soundId = "rbxassetid://75765403283950" 
...
ImageButton.Image = "http://www.roblox.com/asset/?id=75765403283950"
...
local Tabs = {
    ...
    Qs = Window:AddTab({ Title = "vật phẩm", Icon = "" }), 
    stack = Window:AddTab({ Title = "farm mics", Icon = "" }), 
    ...
    spl = Window:AddTab({ Title = "nâng điểm", Icon = "" }),   
...
spawn(function()
 ...
 pcall(function()
  UpdateTime()
		...
		while wait() do
			spawn(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					Elite_Hunter_Status:SetDesc("Status : có")	
				else
					Elite_Hunter_Status:SetDesc("Status : dell có")	
				end
			end)
		end
	end)
    ...
    Kitsune:SetDesc('co kìa húp nẹ' )
    else
      Kitsune:SetDesc('dell có' )
            end
               end
        end)
end)
    ...
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') then
                FrozenIsland:SetDesc('co')
            else
                FrozenIsland:SetDesc('dell co')
            end
        end
    end)
end)
    ...
    Mirragecheck:SetDesc('co')
    else
      Mirragecheck:SetDesc('dell có' )end
            end
        end)
end)
...
function UpdateKitsune()
    if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
        ...
        StatusKitsune:SetDesc("Kitsune Island : dell có")
     end
end
spawn(function()
    pcall(function()
