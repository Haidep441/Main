...
local Main = Library:AddTab("Main","70472011124041")
local M = Library:AddTab("Item","70472011124041")
local Ss = Library:AddTab("Stats","70472011124041")
local RaceV4 = Library:AddTab("Race V4","70472011124041")
local P = Library:AddTab("PVP","70472011124041")
local R = Library:AddTab("Dungeon","70472011124041")
local T = Library:AddTab("Teleport","70472011124041")
local S = Library:AddTab("Shop","70472011124041")
local D = Library:AddTab("Devil Fruit","70472011124041")
local Misc = Library:AddTab("Misc","70472011124041")
local H = Library:AddTab("infor hub","70472011124041")
---------------------------------------------------
...
spawn(function()
    ...
    M:AddToggle("Đã lấyTwinHook", _G.AutoTwinHook,function(value)
         _G.AutoTwinHook = value
        StopTween( _G.AutoTwinHook)
    end)
    
    M:AddToggle("đã lấy Twin Hook Hop", _G.AutoTwinHook_Hop,function(value)
...
S:AddButton("Buy Boat",function()
    ...
    S:AddToggle("yama [ Elite Hunter 30 ]",_G.AutoYama,function(value)
        _G.AutoYama = value
    end)
...
Tabs.infor:AddButton({
        Title = "Server HaiDepZai Hub | Copy Link",
        Description = "https://discord.gg/sắp có",
        Callback = function()
        setclipboard("https://discord.gg/sắp có")
        end
    })
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
game.StarterGui:SetCore("SendNotification", {
...
game.StarterGui:SetCore(
    ...
    {
        Title = "HaiDepZai Hub",
        Text = "vào discord đi mà",
        Icon = "rbxthumb://type=Asset&id=70472011124041&w=150&h=150",
        Duration = 4
    })
