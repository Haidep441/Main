...
ImageButton1.Image = "rbxassetid://70472011124041" -- ảnh button ở ngoài --
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "HaiDepZai hub                                                          [conmemay béo]"
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    UserImage.Image = "rbxassetid://70472011124041"
...
local Logo = Instance.new("ImageLabel")
	...
	Logo.Image = "rbxassetid://70472011124041"
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://70472011124041"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://70472011124041"
...
local Main = Library:AddTab("chính 🏠","70472011124041")
local M = Library:AddTab("vật phẩm ✳️","70472011124041")
local Ss = Library:AddTab("chỉ số 📈","70472011124041")
local RaceV4 = Library:AddTab("tộc V4 🎃","70472011124041")
local P = Library:AddTab("đánh nhau 🗡️","70472011124041")
local R = Library:AddTab("tập kích ☢️","70472011124041")
local T = Library:AddTab("dịch chuyển 🦸","70472011124041")
local S = Library:AddTab("cửa hàng 🛒","70472011124041")
local D = Library:AddTab("trái ác quỷ 🪬","70472011124041")
local Misc = Library:AddTab("linh tinh 🛠️","70472011124041")
---------------------------------------------------
...
while wait(.1) do
    if _G.FastAttack then
       ...
       Main:AddToggle("dịch chuyển",BypassTP,function(value)
        BypassTP = value
    end)
       ...
       Main:AddToggle("đăt điểm hồi sinh",true,function(value)
    _G.Set = value
end)
...
Main:AddToggle("đánh nhanh ",true,function(value)
   ...
   Main:AddToggle("đánh quái xung quanh",_G.AutoFarmNearest,function(value)
...
Main:AddToggle("lụm chest | bay ",false,function(value)
 AutoFarmChest = value
...
Main:AddToggle("lụm Chest Bypass | dễ Kick",false,function(vu)
	_G.ChestBypass = vu
end)
...
if _G.ChestBypass then
    ...
    Main:AddButton("bay sang đảo katakuri",function()
        if BypassTP then
    ...
    Main:AddToggle("tự động cày kata",_G.AutoDoughtBoss,function(value)
    ...
    Main:AddToggle("chiệu hồi kata",true,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Main:AddToggle("đánh kata v2", _G.Autodoughking,function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    Main:AddToggle("đánh kata và đổi sever", _G.AutodoughkingHop,function(value)
...
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    if string.find(v.Name, "trùm") then
...
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    ...
    Main:AddToggle("Farm trùm",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:AddToggle("đánh trùm",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("nhận quest trùm)",false,function(value)
    _G.Auto_Quest_Boss = value
    end)
    
    Main:AddToggle("đánh hết trùm đổi sever",_G.AutoAllBossHop,function(value)
...
Main:AddToggle("tự bật Haki",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
    ...
    Main:AddToggle("HaiDepZai fast",false,function(value)
       _G.HyperSonic = value
    end)      
...
Main:AddToggle("ẩn thông báo",false,function(NamfonGay)
...
Main:AddToggle("ẩn tiếng",false,function(Remo)
_G.RemoveHit = Remo
end)
...
spawn(function()
    ...
    Main:AddToggle("ẩn tốc độ đánh",false,function(value)
    getgenv().A = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).wrapAttackAnimationAsync 
getgenv().B = require(game.Players.LocalPlayer.PlayerScripts.CombatFramework.Particle).play
spawn(function()
...
elseif _G.WhiteScreen == false then
    ...
    if World2 then
        ...
        M:AddToggle("lm nhiệm vụ sea 3",_G.AutoThirdSea,function(value)
...
M:AddToggle("Bay đến đảo kì bí",_G.AutoMysticIsland,function(value)
    ...
    M:AddToggle("Triệu hồi Đảo Huyền Bí",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
M:AddToggle("bay đến gear Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
spawn(function()
    ...
    M:AddToggle("lấy võ Superhuman",_G.AutoSuperhuman,function(value)
    ...
    M:AddToggle("lấy chân đen v2",_G.AutoDeathStep,function(value)
    ...
    M:AddToggle("lấy võ ng cá v2",_G.AutoSharkman,function(value)
    ...
    M:AddToggle("lấy võ điện v2",_G.AutoElectricClaw,function(value)
    ...
    M:AddToggle("lấy võ rồng v2",_G.AutoDragonTalon,function(value)
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=70472011124041",
							Duration = 2.5
						})
					end
...
M:AddSeperator("Nguyên vật liệu")

M:AddToggle("Farm Vật liệu phóng xạ",false,function(value)
Radioactive = value
...
M:AddToggle("Farm răng Ma cà rồng",false,function(value)
BjirVampire = value
...
spawn(function()
    ...
    M:AddToggle("Farm Giọt nước mắt Huyền Bí",false,function(value)
_G.Makori_gay = value
...
spawn(function()
    ...
    M:AddToggle("Farm Quặng Magma",_G.Makori_gay,function(value)
_G.Umm = value
StopTween(_G.Umm)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Đôi cánh thiên thần",_G.Makori_gay,function(value)
_G.Auto_Wing = value
...
spawn(function()
    ...
    M:AddToggle("Farm Da thú",_G.Makori_gay,function(value)
_G.Leather = value
...
spawn(function()
    ...
    M:AddToggle("Farm Kim loại phế liệu",false,function(value)
Scrap = value
StopTween(Scrap)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm bột Ca cao ",false,function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm đuôi cá 3",false,function(value)
Fish = value
StopTween(Fish)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm ngà voi",false,function(value)
MiniHee = value
StopTween(MiniHee)
end)
...
spawn(function()
    ...
    M:AddToggle('đánh giun Biển', false, function(value)
    ...
    spawn(function()
        ...
        M:AddToggle('đánh Tàu cướp biển', _G.KillGhostShip, function(value)
...
M:AddToggle('đánh giun Biển đổi sever', false, function(value)
...
M:AddToggle('Dịch chuyển đến chiều không gian đóng băng [ CẦN SINH RA ]', false, function(value)
...
M:AddToggle("đánh Terror shark (cuttay)",_G.Makori_gay,function(value)
...
M:AddToggle("đánh cá mập con",_G.Makori_gay,function(value)
_G.bjirShark = value
...
spawn(function()
    ...
    M:AddToggle("đánh chim Piranha",_G.Makori_gay,function(value)
...
spawn(function()
        ...
        M:AddToggle('đánh Con tàu ma', _G.bjirFishBoat, function(value)
...
M:AddToggle('lấy mỏ leo [ thiếu nguyên liệu]', _G.BjirAnchorCuy, function(state)
...
spawn(function()
    ...
    M:AddToggle("Tự động lái thuyền ra biển động",_G.BiirTrax,function(state)
    if state then
        _G.BiirTrax = true
    else
        _G.BiirTrax = false
...
spawn(function()
   ...
   M:AddSeperator("Misc Mastery")
    ...
    M:AddToggle("cày tt trái",_G.AutoFarmFruitMastery,function(value)
    ...
    M:AddToggle("cày tt súng",_G.AutoFarmGunMastery,function(value)
    ...
    M:AddToggle("lấy kiếm Buddy đổi sever",_G.AutoBudySwordHop,function(value)
    ...
    M:AddToggle("lấy kiếm law", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    M:AddToggle("lấy kiếm law đổi sever", _G.AutoOderSwordHop,function(value)
...
M:AddToggle("lấy Soul Guitar + đổi sever",false,function(value)
  _G.soulGuitarhop = value    
 end)

 M:AddSeperator("Dual Curse Katana")

M:AddToggle("lấy song đao",_G.AutoCdk,function(value)
...
M:AddToggle("lấy kiếm Tushita", _G.Autotushita,function(value)
    ...
    M:AddToggle("lấy kiếm Tushita đổi sever", _G.Autotushitahop,function(value)
    ...
    M:AddToggle("lấy kiếm Cavander", _G.AutoCarvender,function(value)
         _G.AutoCarvender = value
        StopTween( _G.AutoCarvender)
    end)
    
    M:AddToggle("lấy kiếm Carvander", _G.AutoCarvenderhop,function(value)
...
spawn(function()
    ...
    M:AddToggle("Đã lấy TwinHook", _G.AutoTwinHook,function(value)
         _G.AutoTwinHook = value
        StopTween( _G.AutoTwinHook)
    end)
    
    M:AddToggle("đã lấy Twin Hook đổi sever", _G.AutoTwinHook_Hop,function(value)
    ...
    M:AddToggle("đánh  Elite",_G.AutoElitehunter,function(value)
    ...
    M:AddToggle("đánh Elite đổi sever",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    M:AddSeperator("Hallow Scythe")
    
    M:AddToggle("lấy lưỡi hái",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    M:AddToggle("lấy lưỡi hái đổi sever",_G.AutoFarmBossHallowHop,function(value)
    ...
    M:AddToggle("đánh Rip_Indra",_G.AutoDarkDagger,function(value)
    ...
    M:AddToggle("đánh Rip_Indra đổi sever",_G.AutoDarkDagger_Hop,function(value)
...
M:AddToggle("chiệu hồi Rip Indra [ cần chén]",false,function()
AutoHaki()
wait(0.5) 
local args = {
[1] = "activateColor",
...
HyperCahaya(CFrame.new(-5419.98095703125, 1093.3375244140625, -2666.730712890625))
	...
	M:AddToggle("Lấy cây đinh ba rồng", _G.Auto_Dragon_Trident,function(value)
         _G.Auto_Dragon_Trident = value
        StopTween(_G.Auto_Dragon_Trident)
    end)
    
    M:AddToggle("lấy Dragon Trident đổi sever", _G.Auto_Dragon_Trident_Hop,function(value)
    ...
    M:AddToggle("lấy kiếm Waden đổi sever", _G.Autowadenhop,function(value)
    ...
    M:AddToggle("đánh Râu xám", _G.Autodoughking,function(value)
         _G.Autogay = value
        StopTween( _G.Autogay)
    end)
    
    M:AddToggle("đánh râu xám đổi sever", _G.AutodoughkingHop,function(value)
         _G.Autogayhop = value
    end)
    ...
    M:AddToggle("lấy kiếm Pole v1", _G.Autodoughking,function(value)
         _G.Autopole = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("lấy kiếm Pole v1 đổi sever", _G.AutodoughkingHop,function(value)
    ...
    M:AddToggle("lấy kính Swan đổi sever",_G.AutoFarmSwanGlasses_Hop,function(value)
        _G.AutoFarmSwanGlasses_Hop = value
    end)
    
    M:AddSeperator("Sharks Saw")
    
    M:AddToggle("lấy kiếm shark saw", _G.Autodoughking,function(value)
         _G.Autosaw = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("lấy kiếm Shark Saw đổi sever ", _G.AutodoughkingHop,function(value)
         _G.Autosawhop = value
    end)
    ...
    M:AddToggle("Farm haki Quan sátd đổi sever",_G.AutoObservation_Hop,function(value)
    ...
    M:AddToggle("lấy kiếm saber",_G.AutoSaber,function(value)
				_G.AutoSaber = value
			end)
			
			M:AddToggle("lấy kiếm saber đổi sever",_G.AutoSaberHop,function(value)
 ...
 spawn(function()
    ...
    M:AddToggle("Mua thanh kiếm huyền thoại",_G.AutoBuyLegendarySword,function(value)
    ...
    M:AddToggle("Mua thanh kiếm huyền thoại đổi sever ",_G.AutoBuyLegendarySword_Hop,function(value)
        _G.AutoBuyLegendarySword_Hop = value
    end)
    
    M:AddSeperator("Enchancement Colour")
    
    M:AddToggle("Mua haki huyền thoại",_G.AutoBuyEnchancementColour,function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
    M:AddToggle("Mua haki huyền thoại đổi sever",_G.AutoBuyEnchancementColour_Hop,function(value)
    ...
    M:AddToggle("Nhiệm vụ của công dân",_G.AutoObservationHakiV2,function(x)
    ...
    M:AddToggle("lấy kiếm Rengoku",_G.AutoRengoku,function(value)
    ...
    M:AddToggle("lấy kiếm Yama",_G.AutoYama,function(value)
        _G.AutoYama = value
    ...
    M:AddToggle("làm nhiệm vụ tộc(V2)",_G.Auto_EvoRace,function(value)
    ...
    M:AddToggle("Nhiệm vụ của Bartlio",_G.AutoBartilo,function(value)
    ...
    M:AddToggle("Ngọn đuốc thánh tự động",_G.AutoHolyTorch,function(value)
...
local Melee = Ss:AddLabel("võ : ")
local Defense = Ss:AddLabel("máu : ")
local Sword = Ss:AddLabel("kiếm : ")
local Gun = Ss:AddLabel("súng : ")
local Fruit = Ss:AddLabel("trái ac quỷ : ")
...
Ss:AddToggle("tự động nâng (cuttay)",_G.Auto_Stats_Kaitun,function(value)
...
RaceV4:AddLabel("lên sea 3 điiiiii !!!")
end

if World3 then
    RaceV4:AddSeperator("Race V4")
    
RaceV4:AddButton("Dịch chuyển đến đỉnh GreatTree",function()
  HyperCahaya(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
    end)
    
    RaceV4:AddButton("Dịch chuyển đến thời gian thực",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    
RaceV4:AddButton("Dịch chuyển đến đòn bẩy kéo",function()
  HyperCahaya(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

RaceV4:AddButton("Dịch chuyển đến Acient One (Phải ở trong Temple Of Time!)",function()
  HyperCahaya(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)
   
   RaceV4:AddButton("Đòn bẩy mở khóa.", function()
...
RaceV4:AddToggle("no cuttay ko thì...", nil, function(value)
	game.Players.LocalPlayer.Character.InfiniteStairs.Disabled = value
end)

 
  RaceV4:AddButton("Cửa thử nghiệm dịch chuyển",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    wait(.1)
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    wait(.1)
  ...
  RaceV4:AddToggle("hoàn thành ải V4 (cuttay)",false,function(v)
  _G.AutoQuestRace = v
...
RaceV4:AddToggle("nhìn trăng",_G.LockCamToMoon,function(value)
...
RaceV4:AddToggle("đánh ng trong ải!",false,function(value)
...
spawn(function()
  ...
  RaceV4:AddButton("Mua Ancient One Quest",function(t)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
    ...
    P:AddButton("reset ng chơi",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
    ...
    P:AddToggle("chọn ng chơi",false,function(value)
        SpectatePlys = value
    ...
    P:AddToggle("bay đến ng chơi",false,function(value)
    ...
    P:AddToggle("đánh ng chơi",false,function(value)
    ...
    P:AddButton("nhận nhiệm vụ ng chơi",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
    end)
    
    P:AddToggle("Người chơi Hunter [Đợi cập nhật]",false,function(value)
    ...
    P:AddToggle("ghim skill súng",false,function(value)
        _G.Aimbot_Gun = value
    end)
    ...
    P:AddToggle("ghim Skill",false,function(value)
    ...
    P:AddToggle("tự động bật PvP",false,function(value)
        _G.EnabledPvP = value
    end)
...
spawn(function()
    ...
    R:AddToggle("giết quái trong raid",_G.concubu ,function(vu)
    _G.concubu  = vu
    end)
...
spawn(function()
    ...
    R:AddToggle("Chọn Dungeon",_G.AutoSelectDungeon,function(value)
    ...
    R:AddToggle("Ngục tối tự động bắt đầu",_G.Auto_StartRaid,function(value)
 ...
 R:AddToggle("lấy kiếm law", _G.AutoOderSword,function(value)
     _G.AutoOderSword = value
    StopTween( _G.AutoOderSword)
    end)
    
    R:AddToggle("lấy kiếm law đổi sever", _G.AutoOderSwordHop,function(value)
         _G.AutoOderSwordHop = value
    end)
    ...
    R:AddButton("Mua Microchip Law trùm",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    R:AddButton("vào raid law",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)
    ...
    T:AddButton("về sea 1",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:AddButton("lên sea 2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:AddButton("sang sea 3",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    T:AddButton("ra chỗ giun Biển",function()
        for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
    ...
    S:AddButton("mua dịch chuyển [ $100,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
    
    S:AddButton("mua Haki quan sát [ $750,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
    
S:AddToggle("mua hết ", false, function(t)
    Abilities = t
...
S:AddButton("Buy Boat",function()
    ...
    S:AddButton("mua chân đen | $150,000 Beli ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    end)
    
    S:AddButton("mua võ điện | $550,000 Beli ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
    end)
    ...
    S:AddButton("mua võ rồng | $1,500 Fragments ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    end)
    
    S:AddButton("mua võ siêu nhân | $3,000,000 Beli ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    end)
    
    S:AddButton("mua chân đen v2 | $5,000 Frag $5,000,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
    S:AddButton("mua võ cá v2 | $5,000 Frag | $2,500,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
    S:AddButton("mua võ điện v2 | $5,000 Frag | $3,000,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
    S:AddButton("mua võ rồng v2 |$5,000 Frag | $3,000,000 B ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)

    S:AddButton("mua thần diệt quyền | $5,000 Frag | $5,000,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end)
    -----Shop----------------
    ...
    S:AddButton("Dao găm [ $1,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
    end)

    S:AddButton("kiếm [ $1,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
    end)
    
    S:AddButton("chùy gai [ $25,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
    end)
    
    S:AddButton("song kiếm [ $12,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
    end)
    
    S:AddButton("tam kiếm [ $60,000 Beli ]", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
    end)
    
    S:AddButton("Đường ống [ $100,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
    end)
    
    S:AddButton(" Lưỡi dao hai đầu [ $400,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
    end)
    
    S:AddButton("mua đại đao Bisento [ $1,200,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
    end)
    
    S:AddButton("mua kiếm linh hồn [ $750,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
    end)

    S:AddButton("gậy lôi thể 1[ 5,000 Fragments ]",function()
		game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ThunderGodTalk")
	end)

    S:AddToggle("kiếm yama [ cần giết 30 elite]",_G.AutoYama,function(value)
        _G.AutoYama = value
    end)
    ...
    S:AddButton("Súng cao su [ $5,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Slingshot")
    end)
    
    S:AddButton("Súng hỏa mai [ $8,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Musket")
    end)
    
    S:AddButton("súng [ $10,500 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Flintlock")
    end)
    
    S:AddButton("Súng cao su tinh tế [ $30,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
    end)
    
    S:AddButton("Súng hỏa mai tinh chế [ $65,000 Beli ]",function()
		local args = {
			[1] = "BuyItem",
			[2] = "Refined Flintlock"
		}
    ...
    S:AddButton("Pháo [ $100,000 Beli ]",function()
...
S:AddButton("Đặt lại số liệu thống kê (Use 2.5K Fragments)", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:AddButton("Random tộc (Use 3K Fragments)", function()
    ...
    D:AddToggle("Tự động mua Fruit Sniper",_G.AutoBuyFruitSniper,function(value)
        ...
        D:AddButton("Kiểm tra cửa hàng trái ",function()
...
closeButton.MouseButton1Click:Connect(closeGUI)
    ...
    D:AddToggle("ăn trái",_G.AutoEatFruit,function(value)
    ...
    D:AddToggle("ăn trái đổi sever",_G.AutoEatFruitHop,function(value)
    ...
    D:AddToggle("Random trái",_G.Random_Auto,function(value)
    ...
    D:AddToggle("vứt trái",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    D:AddToggle("cất trái",_G.AutoStoreFruit,function(value)
...
spawn(function()
    ...
    D:AddToggle("nhặt trái [bay]",_G.Grabfruit,function(value)
    _G.Grabfruit = value
    end)
    spawn(function()
			while wait(.1) do
    ...
    D:AddToggle("bay đến trái",_G.Tweenfruit,function(value)
    _G.Tweenfruit = value
    ...
    spawn(function()
        ...
        D:AddToggle("nhặt trái [nhanh dễ kick]",_G.BringFruitBF,function(value)
    ...
    Misc:AddButton("vào sever ít người",function()
...
Misc:AddSeperator("Teams")
    ...
    Misc:AddButton("vào hải tặc",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Misc:AddButton("vào hải quan",function()
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  Misc:AddToggle("Hiển thị bảng xếp hạng đã bị vô hiệu hóa", _G.leaderboard, function(a)
    _G.leaderboard = a
...
Misc:AddToggle("Graphic",false,function(v)
	...
	Misc:AddToggle("Haki 7 màu [mod]",false,function(value)
		RainbowHaki = value
	end)

	Misc:AddToggle("Yoru 7 màu [mod]",false,function(value)
		RainbowYoru = value
	end)
...
repeat wait() until game:IsLoaded() 
	...
	Misc:AddToggle("tự vào lại sever khi bị kick",true,function(value)
		_G.AutoRejoin = value
	end)
...
Misc:AddButton("Kaitun Cap", function(value)
    ...
    Misc:AddButton("fix lag",function()
        pcall(function()
    ...
    Misc:AddToggle("xóa dam",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
...
Misc:AddSeperator("ESP MENU")
    ...
    Misc:AddToggle("định vị ng chơi",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    Misc:AddToggle("định vị rương",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    Misc:AddToggle("định vị trái",false,function(a)
        DevilFruitESP = a
    ...
    Misc:AddToggle("định vị trái câp",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    Misc:AddToggle("định vi hoa",false,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
Misc:AddToggle("định vị trái",IslandESP,function(value)
        IslandESP = value
        while IslandESP do wait()
            UpdateIslandESP() 
        end
    end)
    Misc:AddToggle("định vị npc", false, function(nec)
    NpcESP = nec
end)

Misc:AddToggle("định vị giun biển", false, function(nec)
    SeaESP = nec
end)


Misc:AddToggle("định vị quái", false, function(nec)
    MobESP = nec
end)
    ...
    Misc:AddToggle("đứng trên nước",true,function(value)
        _G.WalkWater = value
    end)
...
CoreGui:SetCore("SendNotification", {
    ...
    Icon = "rbxthumb://type=Asset&id=75765403283950&w=150&h=150",
