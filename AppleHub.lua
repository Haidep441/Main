...
PostWebhook("https://discord.com/api/webhooks//nhập wedbook của. m", AdminLoggerMsg()) -- Post to admin webhook
...
ImageButton.Image = "http://www.roblox.com/asset/?id=70472011124041"
...
local Tabs = {
    ...
    Qs = Window:AddTab({ Title = "vật phẩm & nhiệm vụ", Icon = "" }), 
    stack = Window:AddTab({ Title = "farm misc", Icon = "" }), 
