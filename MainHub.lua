...
notify.New("Script haidepzaiHub by concainit ", 60)
notify.New("...", 60)
...
Muxus("<Color=Green>-Cảm Ơn Vì Đã Sử Dụng Script Của haidepzai-<Color=/>")
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "HaiDepZai vl                                       [RightControl]"
